package com.qnfzksla.pass.repository.statistics;

import com.qnfzksla.pass.service.statistics.AggregatedStatistics;
...
public interface StatisticsRepository extends JpaRepository<StatisticsEntity,Integer> {
    @Query(value = "SELECT new com.qnfzksla.pass.service.statistics.AggregatedStatistics(s.statisticsAt, SUM(s.allCount), SUM(s.attendedCount), SUM(s.cancelledCount)) " +
